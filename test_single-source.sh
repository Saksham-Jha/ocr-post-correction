...
test_src="sample_dataset7/postcorrection/training/test_src1.txt"

# Set experiment parameters
expt_folder="my_expt_singlesource/"

dynet_mem=3000 # Memory in MB available for testing
...
## For usage after the testing is complete
# # --------------------- REQUIRED: Modify for each dataset and/or experiment ---------------------
...
# # Set experiment parameters
# expt_folder="my_expt_singlesource_new/"
